...
import com.addshoping.GoodAdapter.HolderClickListener;
/**
 *
 *
 */
...
//        listView = (GridView)this.findViewById(R.id.listview);
     ...
     *        起始位置
     */
    @SuppressLint("NewApi") private void setAnim(Drawable drawable,int[] start_location){
